<nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-2 shadow   rounded">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="img/freepik-flat-colorful-supermarket-shopping-cart-logo-202411182231493BKZ-removebg-preview.png" alt="" width="150" height="40" class="d-inline-block align-text-top">
    </a>
