...
function verificarPassword($idUsuario, $password){
    ...
    $contrasenia = select($sentencia, [$idUsuario])[7]->password;
...
function conectarBaseDatos() {
	$host = "localhost";
	$db   = "ventas_php"; // Nombre de la base de datos
	$user = "root";
	$pass = "";
	$charset = 'utf8mb4';
	...
	try {
	     ...
	     // Mostrar la hora actual de la base de datos para confirmar la conexión
	     echo "Conexión exitosa. Hora actual en la base de datos: " . $row->current_time;
	     return $pdo;
